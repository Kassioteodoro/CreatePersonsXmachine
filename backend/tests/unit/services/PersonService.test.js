...
describe('testando as regras de negocio do objeto Person', function () {
  ...
  describe('e possivel buscar todos os personagens de um usuario', function () {
    it(sucessTitle, async function () {
      ...
      // execução
      const responseService = await PersonService.getAll(1);
  ...
  describe('e possivel buscar um personagem especifico', function () {
    it(sucessTitle, async function () {
      ...
      // execução
      const responseService = await PersonService.getOne('6348513f34c397abcad040b2');
  ...
  describe('e possivel atualizar um personagem especifico', function () {
    it(sucessTitle, async function () {
      ...
      // execução
      const responseService = await PersonService
      .update(responseFrontUpdate, '6348513f34c397abcad040b2');
      
      // test
      expect(responseService).to.deep.equal({ type: null, message: 'update sucess' });
    });
  });
  describe('e possivel deletar um personagem especifico', function () {
    it(sucessTitle, async function () {
           ...
           // execução
           const responseService = await PersonService.deleted('6348513f34c397abcad040b2');
